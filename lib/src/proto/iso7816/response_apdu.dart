...
const int SW_SUCCESS_1 = 0x90;
const int SW_SUCCESS_2 = 0x00;

// NEW CONSTANTS START HERE
/// Status word for VERIFY command: Failure, retries are available.
const int SW_VERIFY_FAIL = 0x63;

/// Status word for VERIFY command: Authentication method is blocked.
const int SW_AUTH_METHOD_BLOCKED = 0x69;
const int SW_AUTH_METHOD_BLOCKED_2 = 0x83;
