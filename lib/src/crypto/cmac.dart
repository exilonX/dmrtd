...
class FixedCMac extends BaseMac {
  ...
  FixedCMac.fromCipher(BlockCipher cipher) : this(cipher, cipher.blockSize * 8);
  ...
  FixedCMac(BlockCipher cipher, int macSizeInBits)
  ...
  String get algorithmName {
    ...
    return '$blockCipherAlgorithmName/FixedCMAC';
  }
  ...
  static Uint8List lookupPoly(int blockSizeLength) {
    ...
    switch (blockSizeLength * 8) {
      ...
      default:
        throw ArgumentError(
            'Unknown block size for FixedCMAC: ${blockSizeLength * 8}');
    }
